...
const Hero = () => {
    return (
        <section id="home" className="relative min-h-screen flex flex-col justify-between bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "linear-gradient(to right bottom, rgba(8, 47, 73, 0.9), rgba(15, 23, 42, 0.95)), url('https://images.unsplash.com/photo-1565610850-2d8c36236b28?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')" }}>
            ...
            <div className="grow flex items-center relative z-10 w-full pt-20 pb-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl">
                        <div className="mt-10 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800/50 backdrop-blur-md border border-slate-700/50 text-brand-300 text-sm font-semibold mb-8 fade-in-up">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-extrabold text-white leading-[1.1] mb-6 fade-in-up delay-100 tracking-tight">
                            Engineered for <br />
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-brand-400 via-cyan-300 to-teal-200">Maximum Cooling.</span>
                        </h1>
            ...
            <div className="w-full border-t border-white/10 bg-slate-950/40 backdrop-blur-md hidden md:block relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="grid grid-cols-4 gap-12">
                        ...
                        <div className="text-center group border-l border-white/10">
                            ...
                            <p className="text-xs text-slate-400 uppercase tracking-widest font-semibold">Projects Delivered</p>
                        </div>
                        <div className="text-center group border-l border-white/10">
